...
const userElements=document.getElementById('list');
const paginationElements=document.getElementById('pagenation');
...
function displayList(items,wrapper,rowsPerPage,page){
    ...
    for(let i=0;i<paginatedItems.length;i++){
        ...
        userElements.classList.add('item');
        userElements.innerText=item.id;

        wrapper.appendChild(userElements);
    }
}
...
displayList(userList,userElements,rows,currentPage);
SetupPagination(userList,paginationElements,rows);